...
ヘッダー右上に「📖 README」（このページ）と「📄 マニュアルPDF」の2つのボタンがあります。「マニュアルPDF」は、このHTMLファイルと同じ場所に置いた `document` フォルダの中の「施設きゅうりの摘心栽培における生育予測に基づいた栽培管理導入マニュアル.pdf」を新しいタブで開くリンクです。以下のようなフォルダ構成にして初めて開けます。

...
- 「被覆資材」（農PO・農ビ・フッ素フィルム・散乱光（梨地）フィルム・ガラス・硬質板・その他）と「遮光カーテン」（なし／遮光率 30%未満・30〜50%・50%超・不明）はプルダウンから選びます。いまは記録と表示だけで、今後、外気象から補ったハウス内の光（日射・PAR）を見積もるときの透過率の目安に使う予定です。二重被覆などは「その他の設備」に書いてください。
...
| ハウス一覧CSV | 登録ハウスの基本情報（栽植株数・面積に加え、自動計算した株/10a、被覆資材・遮光カーテン、元肥N/P2O5/K2Oも含む） |

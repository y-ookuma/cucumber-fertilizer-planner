...
### DIFの向き
昼夜温差（DIF＝昼温−夜温）は、本アプリでは次の考え方に統一しています（マニュアル本文 p.15「昼夜温差」の記述にもとづきます）。

| DIF | 節間長 | 成長のバランス |
|---|---|---|
| 大きい（昼温＞夜温で、差が大きい） | 長くなる | 栄養成長に傾く |
| 小さい・マイナス（昼温＜夜温） | 短くなる | 生殖成長に傾く |

- 植物ホルモン（GA・IAA）の温度応答によるもので、夜温が低いと夜間の呼吸が抑えられ、同化産物が葉・茎に蓄積します。
- DIFは主に「草姿」（節間の伸び）を決める要因で、花芽形成とは別の働きです。
- そのため「推奨する栽培管理」の「昼夜温差 DIF」の行は、栄養成長へ傾けるときは「DIF大（昼温＞夜温の差を広げる）」、生殖成長へ傾けるときは「DIF小（昼夜の差を縮める。ゼロ〜マイナスでより強く効く）」と表示します。
- 夜温は草勢で決めます（草勢を強める＝夜温を低く、弱める＝夜温を高く）。夜温の上げ下げとDIFの向きが逆になる組み合わせでは、昼温もあわせて動かして差を調整するよう注記します。たとえば「草勢を強める＋生殖成長へ」なら、夜温を下げる分、昼温も下げて差を縮めます。「草勢を弱める＋栄養成長へ」なら、夜温を上げる分、昼温をさらに上げて差を保ちます。
- マニュアルの表2-7（早見表）では「栄養成長へ＝DIFを小さく／生殖成長へ＝DIFを大きく」と、本文とは逆の向きで記載されています。本アプリの早見表は、本文の記述にあわせて直しています。
- 変温管理モデル（表2-1）の気温は、マニュアルの試験での実績値をそのまま表示しています。モデルの栄養成長・生殖成長の区分は、主に高温時間帯（午前／午後）と夕方の降温（緩徐／急速）によるものです。そのため、生殖成長向けのモデルⅤ（DIF 12.2℃）のように、DIFの値だけを見ると上の考え方と合わないものがあります。DIFの向きは「昼夜温差 DIF」の行を優先してください。
...
| DIF | 昼温と夜温の差（昼温−夜温）。昼温＞夜温で差が大きいほど節間長が長くなり栄養成長に、差が小さい・マイナス（昼温＜夜温）ほど節間長が短くなり生殖成長に傾く。植物ホルモン（GA・IAA）の温度応答によるもので、主に草姿を決める要因であり、花芽形成とは別（3章「DIFの向き」参照） |
